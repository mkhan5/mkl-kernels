...
//  float tmpb[3][3] = { 1, 0, 1, 3, -1, -2, 0, 2, -1};
 double tmpa[3][3] = { 7, 24, 25, 19, 2, -17, 26, 11, -23};
   double tmpb[3][3] = { 2, 22, -8, -11, -4, -23, -14, 23, 19};
   double tmpc[3][3] = {-13, 25, -15, -24, 12, 20, -10, -1, -5};
  ...
  //  x[3] = { 2, 1, 3};
   ...
   // }
    ...
    double *tmp_2d_array;
    tmp_2d_array = (double *)mkl_malloc( n*n*sizeof( double ), 64 );
    cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m, n, p, alpha, A, p, B, n, beta, tmp_2d_array, n);
    cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m, n, p, alpha, tmp_2d_array, p, C, n, beta, D, n);
