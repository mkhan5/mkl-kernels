...
int main(int argc, char **argv)
{
   ...
   */
   ...
   // cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m, n, p, alpha, A, p, B, n, beta, C, n);
    cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, minus_scale_100, n, p, alpha, A+(int)(scale_100*p), p, B, n, beta, C+(int)(scale_100*n), n);
   // cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m*(1-scale), n, p, alpha, A+(int)(m*(scale)*p), p, B, n, beta, C+(int)(m*(scale)*n), n);
