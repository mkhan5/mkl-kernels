...
//  float tmpa[4][4] = { -1, -3, -7, 8, 9, 13, -5, -6, -7, 12, 17, 19, 11, -7, 22, -17};
//  float tmpc[4][4] = { -11, 0, 0, 0, 13, -19, 0, 0, -17, -7, 9, 0, 7, -3, -13, 11};   // symmetric - so keep in lower tri form
    float tmpa[3][3] = { -5, 7, -17, 8, 9, -13, -16, -11, 6};
    float tmpb[3][3] = { -6, -13, -11, 9, -7, 14, -17, 8, -15};
    float tmpc[3][3] = { 7, 0, 0, -17, 11, 0, -13, -12, 8};  //symmetric matrix
  ...
  //  x[3] = { 2, 1, 3};
   ...
   // }
    ...
    //cblas_dsyrk (CblasRowMajor, CblasLower, CblasNoTrans, n, m, alpha, A, n, beta, C, n);
	...
	if(debug)
	{
	    ...
	    printf ("\n Top left corner of matrix Result C: \n");
	    for (i=0; i<min(m,6); i++) {
	      for (j=0; j<min(n,6); j++) {
		printf ("%12.0f", C[j+i*n]);
	      }
